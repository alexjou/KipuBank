...
contract KipuBank {
    ...
    /**
     * @dev Construtor que define o limite máximo do banco
     * @param _bankCap O limite máximo do banco em wei
     * IMPORTANTE: Para 1 ETH completo, use 1000000000000000000 (1 seguido de 18 zeros)
     * Exemplo: Para definir 5 ETH como limite: 5000000000000000000
     */
